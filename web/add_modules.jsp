    ...
    <div id="xt-right">
        <div class="pc-kk-form">
            <form action="module" method="post">
                <input type="hidden" name="method" value="addModule">
                ...
                <div class="pc-kk-form-list pc-kk-form-list-clear">
                    ...
                    <div class="nice-select" name="nice-select" style="float:right">
                        <input type="text" name="semester" value="Semester" readonly>
                        <ul>
                ...
                <div class="pc-kk-form-check">
                    <p>Assessment:</p>
                    <input name="assessment" value="Programming" type="checkbox" lab="Programming"/>
                    <input name="assessment" value="Exam" type="checkbox" lab="Exam" />
                    <input name="assessment" value="Quiz" type="checkbox" lab="Quiz" />
                    <input name="assessment" value="Report" type="checkbox" lab="Report" >
                    <input name="assessment" value="Presentation" type="checkbox" lab="Presentation" />
                </div>
                <!-- generate check box according to data from back-end -->
                <div class="pc-kk-form-check">
                    <p>Dependency:</p>
                    <c:forEach items="${module}" var="module">
                        <input name="dependency" value="${module.code} ${module.title}" type="checkbox" lab="${module.code} ${module.title}"/>
                    </c:forEach>
                </div>
                <div class="pc-kk-form-check">
                    <p>Outcomes:</p>
        ...
        <script type="text/javascript">
            $(function() {
                $("input[name='assessment']").richcheckbox();
                $("input[name='dependency']").richcheckbox();
